...
func (_Service *ServiceCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Service.contract.Call(opts, &out, "owner")
...
//
// Solidity: function owner() view returns(address)
func (_Service *ServiceSession) Owner() (common.Address, error) {
	return _Service.Contract.Owner(&_Service.CallOpts)
}

// Owner is a free data retrieval call binding the contract method 0x8da5cb5b.
//
// Solidity: function owner() view returns(address)
func (_Service *ServiceCallerSession) Owner() (common.Address, error) {
	return _Service.Contract.Owner(&_Service.CallOpts)
}
...
// MintTokens is a paid mutator transaction binding the contract method 0x5594ca43.
//
// Solidity: function mintTokens(address _nativeTokenAddress, string _name, string _symbol, uint256 _amount, string _transaction, uint8[] _v, bytes32[] _r, bytes32[] _s) returns()
func (_Service *ServiceTransactor) MintTokens(opts *bind.TransactOpts, _nativeTokenAddress common.Address, _name string, _symbol string, _amount *big.Int, _transaction string, _v []uint8, _r [][32]byte, _s [][32]byte) (*types.Transaction, error) {
	return _Service.contract.Transact(opts, "mintTokens", _nativeTokenAddress, _name, _symbol, _amount, _transaction, _v, _r, _s)
}

// MintTokens is a paid mutator transaction binding the contract method 0x5594ca43.
//
// Solidity: function mintTokens(address _nativeTokenAddress, string _name, string _symbol, uint256 _amount, string _transaction, uint8[] _v, bytes32[] _r, bytes32[] _s) returns()
func (_Service *ServiceSession) MintTokens(_nativeTokenAddress common.Address, _name string, _symbol string, _amount *big.Int, _transaction string, _v []uint8, _r [][32]byte, _s [][32]byte) (*types.Transaction, error) {
	return _Service.Contract.MintTokens(&_Service.TransactOpts, _nativeTokenAddress, _name, _symbol, _amount, _transaction, _v, _r, _s)
}

// MintTokens is a paid mutator transaction binding the contract method 0x5594ca43.
//
// Solidity: function mintTokens(address _nativeTokenAddress, string _name, string _symbol, uint256 _amount, string _transaction, uint8[] _v, bytes32[] _r, bytes32[] _s) returns()
func (_Service *ServiceTransactorSession) MintTokens(_nativeTokenAddress common.Address, _name string, _symbol string, _amount *big.Int, _transaction string, _v []uint8, _r [][32]byte, _s [][32]byte) (*types.Transaction, error) {
	return _Service.Contract.MintTokens(&_Service.TransactOpts, _nativeTokenAddress, _name, _symbol, _amount, _transaction, _v, _r, _s)
}
...
func (_Service *ServiceTransactor) RenounceOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Service.contract.Transact(opts, "renounceOwnership")
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Service *ServiceSession) RenounceOwnership() (*types.Transaction, error) {
	return _Service.Contract.RenounceOwnership(&_Service.TransactOpts)
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Service *ServiceTransactorSession) RenounceOwnership() (*types.Transaction, error) {
	return _Service.Contract.RenounceOwnership(&_Service.TransactOpts)
}
...
func (_Service *ServiceTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _Service.contract.Transact(opts, "transferOwnership", newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Service *ServiceSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
...
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Service *ServiceTransactorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Service.Contract.TransferOwnership(&_Service.TransactOpts, newOwner)
}
...
// ServiceOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the Service contract.
type ServiceOwnershipTransferredIterator struct {
	Event *ServiceOwnershipTransferred // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ServiceOwnershipTransferredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ServiceOwnershipTransferred)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ServiceOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ServiceOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ServiceOwnershipTransferred represents a OwnershipTransferred event raised by the Service contract.
type ServiceOwnershipTransferred struct {
...
func (_Service *ServiceFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*ServiceOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _Service.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &ServiceOwnershipTransferredIterator{contract: _Service.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Service *ServiceFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *ServiceOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Service.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ServiceOwnershipTransferred)
				if err := _Service.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Service *ServiceFilterer) ParseOwnershipTransferred(log types.Log) (*ServiceOwnershipTransferred, error) {
	event := new(ServiceOwnershipTransferred)
	if err := _Service.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
		return nil, err
	}
...
// ServiceTokenBurnIterator is returned from FilterTokenBurn and is used to iterate over the raw logs and unpacked data for TokenBurn events raised by the Service contract.
type ServiceTokenBurnIterator struct {
	Event *ServiceTokenBurn // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ServiceTokenBurnIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ServiceTokenBurnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ServiceTokenBurnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ServiceTokenBurn represents a TokenBurn event raised by the Service contract.
type ServiceTokenBurn struct {
	From               common.Address
...
// FilterTokenBurn is a free log retrieval operation binding the contract event 0xb37c6417ca02c8084d9b4013dd6cb0f56bbd792f58dee3354014d14f714fc16b.
//
// Solidity: event TokenBurn(address indexed from, address indexed sourceTokenAddress, uint256 amount)
func (_Service *ServiceFilterer) FilterTokenBurn(opts *bind.FilterOpts, from []common.Address, sourceTokenAddress []common.Address) (*ServiceTokenBurnIterator, error) {
	...
	logs, sub, err := _Service.contract.FilterLogs(opts, "TokenBurn", fromRule, sourceTokenAddressRule)
	if err != nil {
		return nil, err
	}
	return &ServiceTokenBurnIterator{contract: _Service.contract, event: "TokenBurn", logs: logs, sub: sub}, nil
}

// WatchTokenBurn is a free log subscription operation binding the contract event 0xb37c6417ca02c8084d9b4013dd6cb0f56bbd792f58dee3354014d14f714fc16b.
//
// Solidity: event TokenBurn(address indexed from, address indexed sourceTokenAddress, uint256 amount)
func (_Service *ServiceFilterer) WatchTokenBurn(opts *bind.WatchOpts, sink chan<- *ServiceTokenBurn, from []common.Address, sourceTokenAddress []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Service.contract.WatchLogs(opts, "TokenBurn", fromRule, sourceTokenAddressRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ServiceTokenBurn)
				if err := _Service.contract.UnpackLog(event, "TokenBurn", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTokenBurn is a log parse operation binding the contract event 0xb37c6417ca02c8084d9b4013dd6cb0f56bbd792f58dee3354014d14f714fc16b.
//
// Solidity: event TokenBurn(address indexed from, address indexed sourceTokenAddress, uint256 amount)
func (_Service *ServiceFilterer) ParseTokenBurn(log types.Log) (*ServiceTokenBurn, error) {
	event := new(ServiceTokenBurn)
	if err := _Service.contract.UnpackLog(event, "TokenBurn", log); err != nil {
		return nil, err
	}
